	...
	public static void criarIndiceInvertido(Dicionario estrutura) throws IOException { // Recebe como argumento 
	    ...
	    // for(File file: fileList) {
			...
			while(linha != null) {
				...
				Matcher matcher = pattern.matcher(linha); // linha � a vari�vel que cont�m a linha que foi lida do arquivo
				if (matcher.find()) {
				    String textoEntreAspas = matcher.group(1); // obt�m o grupo lido da regex
